...
LOG_FILE="$LOG_DIR/moe_skip_${LOSS_TYPE}_${DATASET_TYPE}_${CUDA_VISIBLE_DEVICES}.log"
...
OUTPUT_NAME="moe_skip_${DATASET_TYPE}_${LOSS_TYPE}.json"
...
echo "▶ Running moe skconnection with:"
